...
class TestTunUtils(unittest.TestCase):
    def setUp(self):
        ...
        from tun_utils import get_db_connection as original_get_db_connection
    ...
    def test_lagre_bestilling(self):
        ...
        self.cursor.execute("SELECT * FROM tunbroyting_bestillinger WHERE bruker = ?", 
                          (self.test_user,))
    ...
    def test_hent_bestillinger(self):
        ...
        self.cursor.execute('''
            ...
            VALUES (?, ?, ?, ?)
        ''', (self.test_user, self.today.isoformat(), "12:00", "Ukentlig ved bestilling"))
        self.conn.commit()
