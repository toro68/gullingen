...
from weather_utils import get_weather_data_for_period, get_latest_alarms, fetch_and_process_data, get_csv_download_link
...
def handle_weather_page():
    ...
    if start_date is None or end_date is None:
        ...
        if 'error' in weather_data:
            ...
            # Send bare DataFrame til display_weather_data
            display_weather_data(weather_data['df'])

            # Generer nedlastingslink
            download_link = get_csv_download_link(weather_data['df'])
